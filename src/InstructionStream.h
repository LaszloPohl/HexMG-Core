...
//***********************************************************************
    ...
    bool isReplace = false;
    IsDefModelSubcircuitInstruction(bool isReplace_, uns index_, ExternalConnectionSizePack externalNs_, uns sX, InternalNodeVarSizePack internalNs_, uns sI, SolutionType solutionType_, uns sdi)
        :IsInstruction{ sitDefModelSubcircuit }, isReplace{ isReplace_ }, index{ index_ }, externalNs{ externalNs_ }, sumExternalNodes{ sX },
